...
<Picture
  src={
    'https://res.cloudinary.com/duim1pyqp/image/upload/v1645990040/blog/Screen_Shot_2022-02-27_at_2.25.34_PM_dfzezq.jpg'
  }
  alt={'mix-blend-mode aplicado'}
/>

### Confira no CodePen

<CodePenBlend id={'MWOqLwr'} />

## Conclusion

Nowadays, the property **mix-blend-mode** is very [well supported](https://caniuse.com/?search=mix-blend-mode), and we can still use it with a fallback color in addition.
